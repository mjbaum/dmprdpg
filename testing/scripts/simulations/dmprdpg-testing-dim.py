...
parser.add_argument("-d", type=int, dest="d", default=2, const=True, nargs="?",\
	help="Integer: Embedding dimension. Default: d=2.")
...
np.savetxt(input_folder + f"/bootstrap_dim_n={n}_eta={eta}_dim={d}.csv", p_values, delimiter=",")